...
def main():
    ...
    print("prawdopodobienstwo1 ",lrgd1.activation(lrgd1.net_input(X_train_01_subset)))
    print("prawdopodobienstwo2 ",lrgd2.activation(lrgd2.net_input(X_train_01_subset)))
